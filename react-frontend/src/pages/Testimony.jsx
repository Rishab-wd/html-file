...
const testimonials = [
    ...
    },
    {
        ...
        rating: 5,
        halfStar: false,
        text: "The personal training sessions have been game-changing. My trainer holds me accountable, tracks my progress every week, and adjusts the plan as I improve. I've gained significant strength and the results speak for themselves. Worth every rupee!",
...
const StarRating = ({ rating, halfStar }) => {
    return (
        <div className="rating">
            {[1, 2, 3, 4, 5].map(i => {
                if (i <= rating) return <i key={i} className="fa-solid fa-star"></i>;
                if (i === rating + 1 && halfStar) return <i key={i} className="fa-solid fa-star-half-alt"></i>;
        ...
        <main className="testimony-page">
            ...
            <section className="testimony-hero">
                ...
                <div className="testimony-hero-content">
                    <span className="blog-tag-label">REAL STORIES</span>
                    <h1>Member <span>Testimonials</span></h1>
                    <p>Hear from the people who transformed their lives at Fitness Fever. Real results, real people.</p>
                </div>
            </section>
            ...
            <section className="testimony-stats-section">
                <div className="testimony-stats-grid">
                    {stats.map((s, i) => (
                        <div className="testimony-stat" key={i}>
            ...
            <section className="testimony-grid-section">
                <div className="main-text">
                    <h2>What Our Members <strong>Say</strong></h2>
                    <p>Authentic reviews from our community — unedited, unfiltered, and inspiring.</p>
                </div>

                <div className="testimony-grid">
                    {testimonials.map(t => {
                        const isExpanded = expanded === t.id;
                        const longText = t.text.length > 160;
                        return (
                                ...
                                <div className="testimony-card-top">
                                    ...
                                    <div className="testimony-meta">
                                        ...
                                        <div className="testimony-badges">
                                            <span className="badge-goal"><i className="fa-solid fa-bullseye"></i> {t.goal}</span>
                                            <span className="badge-duration"><i className="fa-regular fa-calendar-check"></i> {t.duration}</span>
                                        </div>
                                    </div>
                                </div>

                                <StarRating rating={t.rating} halfStar={t.halfStar} />

                                <p className={`testimony-text ${!isExpanded && longText ? 'clamped' : ''}`}>
                                    "{t.text}"
                                </p>
            ...
            {/* CTA */}
            <section className="testimony-cta-section">
                <div className="blog-cta-box">
                    <i className="fa-solid fa-star blog-cta-icon"></i>
                    <h2>Ready to Write Your Success Story?</h2>
                    <p>Join hundreds of members who have already transformed their bodies and lives at Fitness Fever.</p>
                    <a
                        href="https://wa.me/919833143308?text=Hello%20I%20am%20interested"
